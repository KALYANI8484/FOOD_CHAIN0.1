...
const vTrans = {
  en: {
    ...
    requestSubmittedMsg: 'Your request has been successfully sent to the owner. You will be notified as soon as your request is reviewed and approved.',
  ...
  hi: {
    ...
    requestSubmittedMsg: 'आपका अनुरोध सफलतापूर्वक मालिक को भेज दिया गया है। समीक्षा और स्वीकृति होते ही आपको सूचित किया जाएगा।',
  ...
  mr: {
    ...
    requestSubmittedMsg: 'तुमची विनंती मालकाला यशस्वीरित्या पाठवण्यात आली आहे. पुनरावलोकन आणि मंजुरी मिळताच तुम्हाला कळवले जाईल.',
